...
export class DashboardComponent implements OnInit {
  ...
  saveChanges(): void {
    if (!this.selectedFeedback || !this.selectedFeedback._id) return;

    this.feedbackService.updateFeedback(this.selectedFeedback._id, this.selectedFeedback).subscribe({
      next: () => {
